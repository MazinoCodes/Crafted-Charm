...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col w-[100vw] pt-8 justify-center mx-auto pl-9">
      <div className="flex flex-row justify-between items-center w-[94vw]">
        <h1 className="font-semibold text-xl">Crafted Charm</h1>
        <div className="flex flex-row gap-6 text-[#747373] ">
            <a href="" className="text-[#343A40] font-semibold">Home</a>
            
            <a href="#ourproducts" className="flex flex-row gap-1 items-center">Product </a>
            <a href="">Contact Us</a>
        </div>
      ...
      <div className="flex flex-row justify-around items-center w-[100vw]  mx-auto">
        <div className="flex flex-col items-start gap-8 flex-[1.2]">
          <div className="">
         ...
         <div className="flex flex-col gap-4 mb-[10px]">
            <h1 className="text-[45px] font-semibold">Elevate your Space with Crafted Charm Furniture Designed for Timeless Elegance</h1>
        ...
        <div className="flex flex-row items-center flex-[1.2] justify-center">
          <button className="bg-[#343A4099] w-fit px-4 py-3 rounded-[48px]" onClick={handlePrevImage}><img src={leftArrow} alt="" /></button>
          <img src={heroimg[currentImageIndex]} alt="" />
          <button className="bg-[#343A40] w-fit px-4 py-3 rounded-[48px] " onClick={handleNextImage}> <img src={rightArrow} alt=""  /></button>
        </div>
      </div>
    </div>
  )
