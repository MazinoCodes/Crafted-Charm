...
const Product = ({ products, addToCart }) => {
  ...
  return (
    <div className='bg-[#F5F5F5] w-[100vw] h-[100vh] flex flex-col justify-start pt-5 px-10 overflow-x-hidden gap-12'>
      <Link to="/" className="top-5 absolute rotate-180"><img src={arrow} alt="" /></Link>
      ...
      <div className='flex flex-row items-center'>
        ...
        <div className="flex-1 px-9 flex flex-col items-start gap-6">
          ...
          <p className="text-gray-600 flex flex-row justify-between items-center w-[100%]">
            ...
            <button className="bg-[#343A40] text-white text-sm py-2 px-3 rounded" onClick={handleAddToCart}>
              Add to Cart
            </button>
          </p>
        </div>
