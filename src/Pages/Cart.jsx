...
const Cart = ({ cartItems, removeFromCart, addToCart, removeItemFromCart }) => {
  ...
  return (
    <div className='flex flex-col pt-7 w-[100vw] gap-9 px-6 bg-white phone:w-[100vw]'>
     <Navbar/>
      ...
      <div className='flex flex-col md:flex-row items-start gap-5'>
        <ul className='flex flex-col items-center justify-center gap-9 w-full md:w-[60vw]'>
          {cartItems.map(item => (
            <li key={item.id} className='flex flex-col md:flex-row w-full border-b-2 items-center justify-between p-3 pb-7 gap-5'>
              ...
              <div className='flex flex-row justify-between gap-20 phone:items-center phone:w-full phone:gap-5 '>
              <select className='border-2 border-black px-2 py-2 rounded-[10px]    tablet:px-0 tablet:py-0 phone:px-0 phone:py-0 phone:w-fit flex-1 phone:border-0'>
              ...
              <div className='flex flex-row  items-center phone:gap-4 w-full md:w-auto phone:flex-2 gap-6'>
